...
const $$Clinics = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Clinics;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "clinic" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="inner-page"> <div class="page-heading"> <h1>Clinics 2024/25</h1> </div> <div class="container"></div> </section> ` })}`;
