...
const $$Events = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Events;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "events" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="inner-page"> <div class="page-heading"> <h1>Events</h1> </div> <div class="container"></div> </section> ` })}`;
