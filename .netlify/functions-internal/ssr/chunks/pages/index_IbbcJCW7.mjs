import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderComponent } from '../astro_BSiTW4v7.mjs';
import 'kleur/colors';
import 'html-escaper';
...
</p> </div> <div class="row"> ${masters.map((mastersItem) => renderTemplate`<div class="col-lg-2 col-md-4 col-sm-6 align-items-stretch"> <div class="member"> <div class="member-img"> <img${addAttribute(mastersItem.img, "src")} class="img-fluid" alt=""> </div> <div class="member-info"> <h4>${mastersItem.name}</h4> <span>${mastersItem.region ? mastersItem.region : ""}</span> <span>${mastersItem.title ? mastersItem.title : renderTemplate`<br>`}</span> </div> </div> </div>`)} </div> </div> </section>`;
...
</li> <li><i class="bx bx-chevron-right"></i> Self Control</li> <li><i class="bx bx-chevron-right"></i> Humility</li> <li><i class="bx bx-chevron-right"></i> Indomitable Spirit</li> </ul> </div> </div> <div class="row content"> <div class="col-lg-4"> <img src="assets/img/shin-2.png" class="img-fluid" alt=""> <small>Grandmaster Shin at the Shaolin Monastery, 1984</small> </div> <div class="col-lg-4"> <p>
...
</p> </div> <div class="col-lg-4 pt-4 pt-lg-0"> <img src="assets/img/shin-kick.png" class="img-fluid" alt=""> <small>Grandmaster Shin's flying side kick, 1958</small> <h5 class="red">Five <span>Codes</span></h5> <ul> <li><i class="bx bx-chevron-right"></i> Loyalty to country</li> <li> <i class="bx bx-chevron-right"></i> Obedience to parents
...
</p> <a class="cta-btn" href="/clubs">Find a club</a> </div> </div> </section> <section id="grandmasters" class="team"> <div class="container"> <div class="section-title"> <h2>Grandmasters</h2> <h3>Our <span>Grandmasters</span></h3> </div> <div class="row content"> <div class="col-lg-4"> <h3></h3> <img src="assets/img/gmaster/shin.png" class="img-fluid" alt=""> <small>Kwan Chang Nim Jae Chul Shin, Founder</small> </div> <div class="col-lg-4">
