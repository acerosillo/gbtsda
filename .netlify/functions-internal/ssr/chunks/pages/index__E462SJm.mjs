...
import 'kleur/colors';
import { c as contentfulClient, $ as $$Layout } from './_slug__Co9dqulP.mjs';
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const truncateArticle = (newsArticle) => {
    const plainText = documentToHtmlString(newsArticle).replace(/<[^>]+>/g, "");
    return plainText.length > 90 ? plainText.slice(0, 90) + "..." : plainText;
  };
  const entries = await contentfulClient.getEntries({
    content_type: "tsdNews"
  });
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "news" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="inner-page"> <div class="container"> <section id="breadcrumbs" class="breadcrumbs"> <div class="container"> <ol> <li><a href="/">Home</a></li> <li>News</li> </ol> <h2>News</h2> </div> </section> <section id="blog" class="blog"> <div class="container" data-aos="fade-up"> <div class="row grid"> ${entries.items.map((item) => {
    const slug = slugify(item.fields.newsTitle);
    return renderTemplate`<article class="col-12 col-lg-4"> <div class="entry"> <div class="entry-img"> <a${addAttribute(`/news/${slug}`, "href")}> ${item.fields.newsImage && item.fields.newsImage.length > 0 ? renderTemplate`<img${addAttribute(`https:${item.fields.newsImage[0].fields.file.url}`, "src")}${addAttribute(item.fields.newsImage[0].fields.title || "News image", "alt")}>` : renderTemplate`<img src="img/gbbadge.webp" alt="Placeholder image">`} </a> </div> <div class="entry-meta"> <ul> <li class="d-flex align-items-center"> <i class="bi bi-clock"></i> <a${addAttribute(`/news/${slug}`, "href")}><date>${new Date(item.fields.newsDate).toLocaleDateString()}</date></a> </li> </ul> </div> <h2 class="entry-title"> <a${addAttribute(`/news/${slug}`, "href")}> <h2>${item.fields.newsTitle}</h2> </a> </h2> <div class="entry-content"> <p>${truncateArticle(item.fields.newsArticle)}</p> <div class="read-more"> <a${addAttribute(`/news/${slug}`, "href")}>Read More</a> </div> </div> </div> </article>`;
  })} </div> </div> </section> <!-- ======= Cta Section ======= --> <section id="cta" class="cta"> <div class="container"> <div class="text-center"> <h3>Find your nearest club</h3> <p>
...
const masters = [
  ...
  { id: 15, name: "Master Martin Silk", rank: "Oh Dan", region: "", dannumber: "030702", title: "Northern TSD", img: "assets/img/masters/martinsilk.jpg", pageUrl: "/martinsilk", slug: "martinsilk" },
  { id: 16, name: "Master Donna Harvey", rank: "Sah Dan", region: "", dannumber: "029753", title: "Wisbech & Kings Lynn TSD", img: "assets/img/masters/donnaharvey.jpg", pageUrl: "/donnaharvey", slug: "donnaharvey" },
  ...
  { id: 19, name: "Master Lesley Allen", rank: "Oh Dan", region: "", dannumber: "031730", title: "Chatteris TSD", img: "assets/img/masters/lesleyallen.jpg", pageUrl: "/lesleyallen", slug: "lesleyallen" },
  { id: 20, name: "Master Rachel Woodford", rank: "Oh Dan", region: "", dannumber: "031731", title: "Frome Valley TSD", img: "assets/img/masters/rachelwoodford.jpg", pageUrl: "/rachelwoodford", slug: "rachelwoodford" },
  { id: 21, name: "Master Ashley Robertson", rank: "Oh Dan", region: "", dannumber: "032249", title: "Melbourn TSD", img: "assets/img/masters/ashleyrobertson.jpg", pageUrl: "/ashleyrobertson", slug: "ashleyrobertson" },
  ...
  { id: 23, name: "Master Robbie Tyler", rank: "Oh Dan", region: "", dannumber: "033231", title: "Market Deeping TSD", img: "assets/img/masters/robbietyler.jpg", pageUrl: "/robbietyler", slug: "robbietyler" },
...
</p> </div> <div class="row"> ${masters.map((mastersItem) => renderTemplate`<div class="col-6 col-lg-2 col-md-4 col-sm-4 align-items-stretch"> <div class="member"> <div class="member-img"> <img${addAttribute(mastersItem.img, "src")} class="img-fluid" alt=""> </div> <div class="member-info"> <h4>${mastersItem.name}</h4> <span>${mastersItem.rank ? mastersItem.rank : ""}</span> <span>${mastersItem.dannumber ? `#${mastersItem.dannumber}` : ""}</span> <span>${mastersItem.region ? mastersItem.region : ""}</span> <span>${mastersItem.title ? mastersItem.title : renderTemplate`<br>`}</span> </div> </div> </div>`)} </div> </div> </section>`;
