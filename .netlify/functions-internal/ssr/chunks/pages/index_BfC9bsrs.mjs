...
import 'kleur/colors';
import { c as contentfulClient, $ as $$Layout } from './_slug__D80zuhMt.mjs';
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "news" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="inner-page"> <div class="container"> <!-- ======= Breadcrumbs ======= --> <section id="breadcrumbs" class="breadcrumbs"> <div class="container"> <ol> <li><a href="/">Home</a></li> <li>News</li> </ol> <h2>News</h2> </div> </section> <!-- End Breadcrumbs --> <!-- ======= Blog Section ======= --> <section id="blog" class="blog"> <div class="container" data-aos="fade-up"> <div class="row"> <div class="col-lg-10 entries"> ${entries.items.map((item) => {
    ...
    return renderTemplate`<article class="entry"> <div class="entry-img"> ${item.fields.newsImage && item.fields.newsImage.length > 0 && renderTemplate`<img${addAttribute(`https:${item.fields.newsImage[0].fields.file.url}`, "src")}${addAttribute(item.fields.newsImage[0].fields.title || "News image", "alt")}>`} </div> <div class="entry-meta"> <ul> <li class="d-flex align-items-center"> <i class="bi bi-clock"></i> <a${addAttribute(`/news/${slug}`, "href")}> <date>${new Date(item.fields.newsDate).toLocaleDateString()}</date> </a> </li> </ul> </div> <h2 class="entry-title"> <a${addAttribute(`/news/${slug}`, "href")}> ${item.fields.newsTitle} </a> </h2> <div class="entry-content"> <div>${unescapeHTML(documentToHtmlString(item.fields.newsArticle))}</div> <div class="read-more"> <a${addAttribute(`/news/${slug}`, "href")}>Read More</a> </div> </div> </article>`;
