...
const $$ClubInstructors = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Club Instructors" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="inner-page"> <div class="container"> <br><br><br><br> <h1>Club Instructors</h1> <p>
Meet our Club Instructors of Great Britain Tang Soo Do
</p> <div class="row"> ${clubinstructors.map((ci) => renderTemplate`<div class="col-lg-2 col-md-4 col-sm-6 align-items-stretch"> <div class="member"> <div class="member-img"> <img${addAttribute(ci.img, "src")} class="img-fluid" alt=""> </div> <div class="member-info"> <h4>${ci.name}</h4> <span>${ci.region ? ci.region : ""}</span> <span>${ci.title ? ci.title : renderTemplate`<br>`}</span> </div> </div> </div>`)} </div> </div> </section> ` })}`;
