...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Header;
  return renderTemplate`${maybeRenderHead()}<header id="header" class="fixed-top"> <div class="container d-flex align-items-center justify-content-between"> <h1 class="logo"><a href="/">Great Britain Tang Soo Do</a></h1> <nav id="navbar" class="navbar"> <ul> ${naviData.map((navigation) => renderTemplate`${renderComponent($$result, "Navigation", $$Navigation, { "navigation": navigation })}`)} </ul> <i class="bi bi-list mobile-nav-toggle"></i> </nav> </div> </header>`;
