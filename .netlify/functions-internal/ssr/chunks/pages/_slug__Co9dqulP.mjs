...
const CookieConsent = () => {
  ...
  if (!isVisible)
    return null;
  return /* @__PURE__ */ jsxs("div", { className: "cookies-popup", children: [
    /* @__PURE__ */ jsxs("p", { children: [
      "This website uses cookies to ensure you get the best experience on our website.",
      " ",
      /* @__PURE__ */ jsx("a", { href: "/privacy-policy", children: "Learn more" })
    ] }),
    /* @__PURE__ */ jsx("button", { onClick: acceptCookies, children: "Accept" }),
