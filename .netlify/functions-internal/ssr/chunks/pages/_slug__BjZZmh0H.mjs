...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "news-item" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="inner-page"> <div class="container"> <!-- ======= Breadcrumbs ======= --> <section id="breadcrumbs" class="breadcrumbs"> <div class="container"> <ol> <li><a href="/">Home</a></li> <li><a href="/news">News</a></li> <li>${newsItem.fields.newsTitle}</li> </ol> <h2>News</h2> </div> </section> <!-- End Breadcrumbs --> <!-- ======= Blog Section ======= --> <section id="blog" class="blog"> <div class="container" data-aos="fade-up"> <div class="row"> <div class="col-lg-10 entries"> <article class="entry"> ${newsItem.fields.newsImage && newsItem.fields.newsImage.length > 0 && renderTemplate`<div> ${newsItem.fields.newsImage.map((image, index) => renderTemplate`<img${addAttribute(index, "key")}${addAttribute(`https:${image.fields.file.url}`, "src")}${addAttribute(image.fields.title || `News image ${index + 1}`, "alt")}>`)} </div>`} <div class="entry-meta"> <ul> <li class="d-flex align-items-center"> <i class="bi bi-clock"></i> <a href="{\`/news/\${slug}\`}"><date>${new Date(newsItem.fields.newsDate).toLocaleDateString()}</date></a> </li> </ul> </div> <h2 class="entry-title"> ${newsItem.fields.newsTitle} </h2> <div class="entry-content"> <article>${unescapeHTML(documentToHtmlString(newsItem.fields.newsArticle))}</article> </div> </article> <!-- End blog entry --> </div> <!-- End blog entries list --> <!-- End blog sidebar --> </div> </div> </section> <!-- End Blog Section --> <!-- ======= Cta Section ======= --> <section id="cta" class="cta"> <div class="container"> <div class="text-center"> <h3>Find your nearest club</h3> <p>
