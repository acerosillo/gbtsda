...
const $$Clubs = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Clubs;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "homepage" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="inner-page"> <div class="page-heading"> <h1>Clubs</h1> <p>
Please select a region for your nearest club :
</p> ${renderComponent($$result2, "ClubFilter", ClubFilter, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/acerosillo/Desktop/dev/gbtsda/src/components/ClubFilter.jsx", "client:component-export": "default" })} </div> <div class="container"></div> </section> ` })}`;
